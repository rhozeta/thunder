...
export function ThreeDayView({ tasks, selectedDate, onDateSelect, onEditTask }: ThreeDayViewProps) {
  const days = [
    selectedDate,
  ...
  return (
    <div className="h-full overflow-auto">
      <div className="overflow-x-auto">
        <div className="grid grid-cols-3 gap-4 p-4 min-w-max" style={{ minWidth: '900px' }}>
        {days.map(day => {
